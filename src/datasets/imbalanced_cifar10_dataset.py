...
class ImbalancedCIFAR10(VisionDataset, ImbalancedDatasetMixin):
    ...
    Modified from official PyTorch implementation
    ...
    def __init__(
        ...
        inputs, targets = self.data, self.targets
        inputs, targets = self.select_classes(inputs, targets, desired_classes)
        inputs, targets = self.resample_dataset(
            inputs,
            targets,
            desired_classes,
            num_undersample_per_class,
    ...
    def _load_meta(self) -> None:
        ...
        # TODO: adapt to when labels are remapped
        self.classes = None
...
class ImbalancedCIFAR100(ImbalancedCIFAR10):
    """`CIFAR100 <https://www.cs.toronto.edu/~kriz/cifar.html>`_ Dataset.

    This is a subclass of the `ImbalancedCIFAR10` Dataset.
    Modified from official PyTorch implementation
    """
